...
\item research significance for~\emph{malaria}:
    \begin{itemize}
	\item better picture  of~insecticide-resistance alleles in~\emph{Anopheles gambiae}
...
\item to~produce a~step change in~inferential abilities of~natural evolution

\item and lay foundations of~deep learning applications to population genetics
\end{itemize}
